...
| Segment storage | Retain and hash the synchronized old file, durably install the empty successor |
...
After publication succeeds, Log switches appenders and writes/syncs new records.
