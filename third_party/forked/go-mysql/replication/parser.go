...
func (p *BinlogParser) SetUseNumberForJSONDecimal(useNumberForJSONDecimal bool) {
	p.useNumberForJSONDecimal = useNumberForJSONDecimal
}
...
func (p *BinlogParser) newRowsEvent(h *EventHeader) *RowsEvent {
	...
	e.useNumberForJSONDecimal = p.useNumberForJSONDecimal
